...
+(NSArray *)getChapterArray
{
    ...
    TextPageOfBook *ch14Page31 = [[TextPageOfBook alloc] initWithPath:@"CH14-31" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"parchment10" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:@"CH14_Liquid Cave Drip" andOneTimeAudioFileType:@"wav" andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil];
