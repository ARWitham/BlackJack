...
+(NSArray *)getChapterArray
{
    ...
    TextPageOfBook *ch07Page13 = [[TextPageOfBook alloc] initWithPath:@"CH07-13" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"parchment12" andBackgroundImageFileType:@"jpg" andOverlay:kBJNone andOneTimeAudioPath:@"CH07_Boat" andOneTimeAudioFileType:@"wav" andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil];
