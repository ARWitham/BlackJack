...
+(NSArray *)getChapterArray
{
    ...
    TextPageOfBook *ch01Page14 = [[TextPageOfBook alloc] initWithPath:@"CH01-14" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"background12" andBackgroundImageFileType:@"jpg" andOverlay:kBJNone andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil];
    ...
    TextPageOfBook *ch01Page16 = [[TextPageOfBook alloc] initWithPath:@"CH01-16" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"background14" andBackgroundImageFileType:@"jpg" andOverlay:kBJNone andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil];
    ...
    TextPageOfBook *ch01Page24 = [[TextPageOfBook alloc] initWithPath:@"CH01-24" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"background06" andBackgroundImageFileType:@"jpg" andOverlay:kBJNone andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil];
    ...
    TextPageOfBook *ch01Page26 = [[TextPageOfBook alloc] initWithPath:@"CH01-26" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"background08" andBackgroundImageFileType:@"jpg" andOverlay:kBJNone andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil];
    ...
    TextPageOfBook *ch01Page40 = [[TextPageOfBook alloc] initWithPath:@"CH01-40" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"background06" andBackgroundImageFileType:@"jpg" andFlourishName:@"CH01_Isotope_Animation" andFlourishXAxis:130 andFlourishYAxis:134 andOverlay:kBJNone andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil];
