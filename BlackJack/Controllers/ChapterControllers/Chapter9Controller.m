...
+(NSArray *)getChapterArray
{
    ...
    TextPageOfBook *ch09Page17 = [[[TextPageOfBook alloc] initWithPath:@"CH09-17" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"CH09_DemonParchment1" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil] autorelease];
    TextPageOfBook *ch09Page18 = [[[TextPageOfBook alloc] initWithPath:@"CH09-18" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"CH09_DemonParchment2" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil] autorelease];
