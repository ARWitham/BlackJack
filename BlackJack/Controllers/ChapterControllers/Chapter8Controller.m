...
+(NSArray *)getChapterArray
{
    ...
    TextPageOfBook *ch08Page31 = [[[TextPageOfBook alloc] initWithPath:@"CH08-31" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"parchment10" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:@"CH08_Standalone SFX - Thump and Shudder" andOneTimeAudioFileType:@"wav" andOneTimeAudioDelay:6 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil] autorelease];
