...
+(NSArray *)getChapterArray
{
    ...
    TextPageOfBook *ch16Page35 = [[TextPageOfBook alloc] initWithPath:nil andTextPageImageFileType:nil andBackgroundimageFilePath:@"CH16_Frozen4" andBackgroundImageFileType:@"jpg" andFlourishName:@"CH16_IrrationalHypo_" andFlourishXAxis:0 andFlourishYAxis:0 andOverlay:kBJNone andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:@"CH16_Ice Wind" andMultiPageAudioFileType:@"wav"];
