...
+(NSArray *)getChapterArray
{
    ...
    TextPageOfBook *ch06Page12 = [[TextPageOfBook alloc] initWithPath:@"CH06-12" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"parchment11" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:@"CH06_Standalone SFX - War Horn" andOneTimeAudioFileType:@"wav" andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil];
    ...
    TextPageOfBook *ch06Page27 = [[TextPageOfBook alloc] initWithPath:@"CH06-27" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"parchment6" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:@"CH06_Standalone SFX - Thunder Ocean Rain" andOneTimeAudioFileType:@"wav" andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil];
