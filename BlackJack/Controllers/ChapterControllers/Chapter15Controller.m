...
+(NSArray *)getChapterArray
{
    ...
    TextPageOfBook *ch15Page26 = [[TextPageOfBook alloc] initWithPath:@"CH15-26" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"CH15_Crimson_2" andBackgroundImageFileType:@"jpg" andOverlay:kBJNone andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil];
    ...
    TextPageOfBook *ch15Page32 = [[TextPageOfBook alloc] initWithPath:@"CH15-32" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"CH15_DemonParchment3" andBackgroundImageFileType:@"jpg" andOverlay:kBJNone andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil];
