...
+(NSArray *)getChapterArray
{
    ...
    TextPageOfBook *ch13Page32 = [[[TextPageOfBook alloc] initWithPath:@"CH13-32" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"parchment11" andBackgroundImageFileType:@"jpg" andFlourishName:@"CH13_staffLayered_" andFlourishXAxis:50 andFlourishYAxis:185 andOverlay:nil andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil] autorelease];
