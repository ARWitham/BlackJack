...
+(NSArray *)getChapterArray
{
    ...
    TextPageOfBook *ch13Page04 = [[[TextPageOfBook alloc] initWithPath:@"CH13-4" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"CH13_titian5" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil] autorelease];
    TextPageOfBook *ch13Page05 = [[[TextPageOfBook alloc] initWithPath:@"CH13-5" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"CH13_titian2" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil] autorelease];
    TextPageOfBook *ch13Page06 = [[[TextPageOfBook alloc] initWithPath:@"CH13-6" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"CH13_titian3" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil] autorelease];
    TextPageOfBook *ch13Page07 = [[[TextPageOfBook alloc] initWithPath:@"CH13-7" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"CH13_titian4" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil] autorelease];
    ...
    TextPageOfBook *ch13Page23 = [[[TextPageOfBook alloc] initWithPath:@"CH13-23" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"CH13_white1" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil] autorelease];
    TextPageOfBook *ch13Page24 = [[[TextPageOfBook alloc] initWithPath:@"CH13-24" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"CH13_white2" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil] autorelease];
    TextPageOfBook *ch13Page25 = [[[TextPageOfBook alloc] initWithPath:@"CH13-25" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"CH13_white3" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil] autorelease];
    ...
    TextPageOfBook *ch13Page32 = [[[TextPageOfBook alloc] initWithPath:@"CH13-32" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"parchment11" andBackgroundImageFileType:@"jpg" andFlourishName:@"CH13_EquationLayered_" andFlourishXAxis:50 andFlourishYAxis:185 andOverlay:nil andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil] autorelease];
