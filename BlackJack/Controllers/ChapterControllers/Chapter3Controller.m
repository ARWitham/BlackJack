...
+(NSArray *)getChapterArray
{
    ...
    TextPageOfBook *ch03Page14 = [[[TextPageOfBook alloc] initWithPath:@"CH03-14" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"antique2" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:@"CH03_Ocean" andMultiPageAudioFileType:@"wav"] autorelease];
    ...
    TextPageOfBook *ch03Page16 = [[[TextPageOfBook alloc] initWithPath:@"CH03-16" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"antique4" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:@"CH03_Ocean" andMultiPageAudioFileType:@"wav"] autorelease];
    TextPageOfBook *ch03Page17 = [[[TextPageOfBook alloc] initWithPath:@"CH03-17" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"antique5" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:@"CH03_Ocean" andMultiPageAudioFileType:@"wav"] autorelease];
