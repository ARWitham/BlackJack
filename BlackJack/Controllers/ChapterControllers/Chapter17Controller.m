...
+(NSArray *)getChapterArray
{
    ...
    TextPageOfBook *ch17Page02 = [[[TextPageOfBook alloc] initWithPath:@"CH17-2" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"CH17_Indigo1" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil] autorelease];
    TextPageOfBook *ch17Page03 = [[[TextPageOfBook alloc] initWithPath:@"CH17-3" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"CH17_Indigo2" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil] autorelease];
    TextPageOfBook *ch17Page04 = [[[TextPageOfBook alloc] initWithPath:@"CH17-4" andTextPageImageFileType:@"png" andBackgroundimageFilePath:@"CH17_Indigo3" andBackgroundImageFileType:@"jpg" andOverlay:nil andOneTimeAudioPath:nil andOneTimeAudioFileType:nil andOneTimeAudioDelay:0 andMultiPageAudioPath:nil andMultiPageAudioFileType:nil] autorelease];
